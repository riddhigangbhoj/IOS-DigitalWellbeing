                    ...
                    React.createElement('div', { style: { padding: '20px 22px 22px' } },
                        ...
                        React.createElement('div', {
                            ...
                            React.createElement('div', {
                                ...
                                React.createElement('div', {
                                    ...
                                    React.createElement('i', {
                                        className: 'ph-fill ph-cpu',
                                        style: { fontSize: '13px', color: '#007aff' }
                                    })
                                ),
                                React.createElement('div', { style: { flex: 1 } },
                                    React.createElement('div', {
                                        style: { fontSize: '12.5px', fontWeight: '500', color: '#1a1a1a', marginBottom: '2px', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Text", sans-serif' }
                                    }, 'On-Device AI'),
                                    React.createElement('div', {
                                        style: { fontSize: '11px', color: '#8e8e93', lineHeight: '1.45', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Text", sans-serif' }
                                    }, 'Patterns analyzed locally on your device using an AI model.')
                                )
                            ),
                            // Divider
                            React.createElement('div', { style: { height: '1px', background: '#e8e8ed', marginLeft: '36px' } }),
                            // Row 2 - Private & Secure
                            React.createElement('div', {
                                style: { display: 'flex', gap: '10px', alignItems: 'flex-start' }
                            },
                                React.createElement('div', {
                                ...
                                React.createElement('div', { style: { flex: 1 } },
                                    ...
                                    React.createElement('div', {
                                        style: { fontSize: '11px', color: '#8e8e93', lineHeight: '1.45', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Text", sans-serif' }
                                    }, 'Your data never leaves your phone. No external servers.')
                                )
                            )
                        ),
                        // Got it button
                        ...
                        React.createElement('button', {
                            ...
                            React.createElement('i', {
                                ...
                                style: { fontSize: '11px', color: '#c7c7cc', marginLeft: '2px' }
                            })
                        ),
                        ...
                        React.createElement('button', {
                            ...
                            React.createElement('i', {
                                className: trackingEnabled ? 'ph ph-pause' : 'ph ph-play',
                                style: { fontSize: '14px' }
                            }),
                            ...
                            ...[
                                ...
                                React.createElement('div', {
                                    ...
                                    style: {
                                        ...
                                        gap: '10px',
                                        padding: '10px 0',
                                        borderBottom: idx < 5 ? '1px solid #ebebf0' : 'none'
                                    }
                                },
                                    React.createElement('div', {
                                        style: {
                                        ...
                                        React.createElement('i', {
                                            ...
                                            style: { fontSize: '14px', color: cat.iconColor }
                                        })
                                    ),
                                    React.createElement('div', { style: { flex: 1, minWidth: 0 } },
                                        React.createElement('div', {
                                            style: { fontSize: '12.5px', fontWeight: '500', color: categoryToggles[cat.key] ? '#1a1a1a' : '#8e8e93', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Text", sans-serif', transition: 'color 0.2s' }
                                        }, cat.label),
                                        React.createElement('div', {
                                            style: { fontSize: '10px', color: '#aeaeb2', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Text", sans-serif' }
                                        }, cat.desc)
                                    ),
                                    // iOS-style toggle
                                    React.createElement('div', {
